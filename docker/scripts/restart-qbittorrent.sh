...
# otherwise, qbitorrent loses connection

GLUETUN_CONTAINER_NAME=${GLUETUN_CONTAINER_NAME:-vpn}
QBITTORRENT_CONTAINER_NAME=${QBITTORRENT_CONTAINER_NAME:-qbittorrent}
